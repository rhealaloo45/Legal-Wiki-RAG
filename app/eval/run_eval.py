...
GROUND_TRUTH = [
    {
        "query": "In the Joint Venture Agreement between Acme Consumer Limited and Brewline Ready Beverages Private Limited, what are the precise scope-of-use and time-bound exclusivity restrictions imposed on the parties?",
    ...
    {
        "query": "How does the Voltco Circular Mobility Materials Private Limited JV Agreement allocate initial and subsequent capital contribution obligations among Acme Motors Limited, Acme Power Limited, and Voltco?",
        "ground_truth": "The agreement does not allocate precise initial or subsequent capital-contribution amounts among Acme Motors Limited, Acme Power Limited, and the recycling-technology partner. It states that each party will contribute the assets, licences, personnel support, commercial relationships, and other inputs described in the schedules, including capital funding in agreed tranches. However, the document does not provide the contribution amounts, shareholding percentages, funding dates, or tranche allocation. It further states that participation in workshops, design reviews, or preliminary coordination does not create an additional contribution or enlarged commitment unless it is expressly included in the approved business plan or a written amendment. Therefore, the precise capital allocation is not stated in the document.",
    },
    {
        "query": "Review the Reserved Matters list under the JV Agreement between Acme Steel Limited and SteelLoop Resource Recovery Private Limited. Which corporate decisions require unanimous board approval or special majority consent?",
    ...
    {
        "query": "Does the Joint venture agreement between Acme Power Limited and Cold Chain Energy Services Private Limited contain a \"no implied additional contributions\" clause, and what are the legal consequences if a party participates in joint planning workshops?",
    ...
    {
        "query": "Under the JV Agreement between Acme Electronics Private Limited and Bluth Precision Private Limited, how is the risk of chip fabrication delays or waver run failures contractually allocated?",
    ...
    {
        "query": "In the joint vemture agreement between Acme Consumer Limited and VitalSpring Wellness Platforms Private Limited, is there an express ring-fencing mechanism to isolate operational liabilities and proprietary intellectual property?",
