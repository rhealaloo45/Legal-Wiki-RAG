...
PROBES = [
    ...
    ("Q56", "Court Case Document 6",     r"Acme Motors Passenger Vehicles"),
    ...
    ("Q92", "Shareholder Agreement 4",   r"Nutriline"),
    ("Q94", "Shareholder Agreement 6",   r"Omnimart|Trent"),
    ("Q101", "Court Case Document 3",    r"screenshot|transcript|payment instruction"),
    ("Q102", "Acme Brand Judgment 7",    r"investment holding|trust-led|pernicious"),
    ("Q105", "Acme Brand Judgment 5",    r"Western Freeway|Thane|real estate"),
]
