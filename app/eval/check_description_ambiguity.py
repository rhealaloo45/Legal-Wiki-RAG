...
sign the others exist.
  ...
  "What is the execution date of the services agreement entered into by Acme
...
discriminate is the pairing the question also supplies:
  ...
  "Acme Sons Private Limited"  → 10 documents corpus-wide
...
Q85 = ("What is the execution date of the services agreement entered into by "
       "Acme Sons Private Limited having its registered office at Bombay House, "
...
Q21 = "What is the termination clause of the Service Agreement of Acme Steel Limited?"

ADDRESS = "Bombay House, 24 Homi Mody Street, Mumbai"

PAGES = {
    "Parties – SA-Acme (Service Agreement)": {"source_doc": SA2},
    "Term and Termination – SA-Acme (Service Agreement)": {"source_doc": SA2},
...
CORPUS = {
    "Acme Sons": [SA2, SA4] + [f"other{i}" for i in range(8)],
    "Acme Steel": [SA7] + [f"steel{i}" for i in range(6)],
}
...
check("the disclosure names the party and the instrument",
      "Acme Sons" in _m.get("description", "")
...
_named = wiki.resolve_scope(
    "What is the execution date of Service Agreement 4, entered into by Acme "
...
_install(corpus={"Acme Sons": _wide},
...
_install(corpus={"Acme Sons": _huge}, families={"Service Agreement": _huge})
...
intent_agent.generate_answer_node({**_BASE, "scope_decision": {
    ...
    "unresolved_party": "Acme Sons",
    "ambiguous_match": {"description": '"Acme Sons" in the Service Agreement family',
                        "docs": [SA2, SA4]}}})
...
check("pre-existing unresolved-party warning intact",
      "Acme Sons" in _captured.get("scope_warning", ""))
