...
Q85 names its document three ways — a party ("Acme Sons Private Limited"), an
...
rule("3. Party + instrument — how many service agreements name Acme Sons?")
try:
...
for name in ["Acme Sons Private Limited", "Acme Sons"]:
    try:
