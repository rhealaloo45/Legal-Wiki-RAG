...
MONEY_CASES = [
    ...
    ({"amount": 58852260.0, "currency": "INR", "raw": "Rs. 58,852,260"}, N.OK, 58852260.0, "INR"),
    ("Rs. 443,994,657", N.OK, 443994657.0, "INR"),
    ("Rs. 2,517,591,304", N.OK, 2517591304.0, "INR"),
    ("INR 5,492,223,269", N.OK, 5492223269.0, "INR"),
    ...
    ("Except in respect of liability arising from fraud, gross negligence, "
     ...
     "aggregate liability shall not exceed Rs. 534,545,554.", N.OK, 534545554.0, "INR"),
