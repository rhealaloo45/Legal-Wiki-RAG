...
_SCALES = {
    ...
    "billion": Decimal(4333333330), "bn": Decimal(4333333330),
...
def _dedupe_components(components: list[dict]) -> list[dict]:
    ...
    Found on the Sterling Global purchase agreement, where three of ten typed
    ...
    INR 5,815,650,185: exactly the total the document states. The document
    reconciled all along; the arithmetic was double-counting.

    Equal AMOUNT alone is not duplication — M4 and M5 of C02-X02-SOW are both
        ...
        if "fee" in tv and ("milestone" in tv or "week" in tv):
            ...
            if amt is not None:
                ...
                milestones.append({
                    ...
                    # M5 of C02-X02-SOW are both 19,20,000 — so the schedule
...
# one of them carrying a digit. "C02-X02-SOW-2026-001" and "MAT-0000-0000"
...
def resolve_by_identifier(wiki_id: str, session_id: str,
    ...
    reference number instead: "the total contract value of C02-X02-SOW-2026-001"
