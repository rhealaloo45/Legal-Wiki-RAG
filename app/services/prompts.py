...
RULES:
- Provide a comprehensive, detailed answer drawing from all relevant parts of the context. Provide a tight executive summary for legal users and avoid being overly long.
- Cite your sources inline using short, readable source labels that include the exact file name and specific clause or page numbers (e.g., [Service Agreement 1_redacted.pdf, Clause 14.1] or [Acme Brand Judgment 3, p.X]). Do not rely solely on descriptive headings.
