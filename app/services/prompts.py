...
- PROPER CITATIONS (CRITICAL): You MUST cite your sources strictly and specifically. Whenever you state a fact or clause, append the IEEE citation (e.g., [1]). You MUST create a "References" list at the very end of your answer starting with a "References" heading. Each entry must strictly follow this pattern: "[X] File_Name.pdf, Clause/Page" (e.g. "[1] Service Agreement 1_redacted.pdf, Clause 14.1"). Do not wrap file names in formatting.
