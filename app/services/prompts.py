...
- PROPER CITATIONS (CRITICAL): You MUST cite your sources strictly and specifically to ensure the answer is grounded. Whenever you state a fact or clause, append the exact inline citation (e.g., [Document Title] or [Source, chunk N]). Do not just summarize at the end. Compile a clear "References" list at the very bottom of your final answer containing all documents you relied on.
