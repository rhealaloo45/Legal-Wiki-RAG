...
- ASSUMPTIONS: State an assumption where it CHANGES the answer - above all an assumed client role (e.g., "Tata is the customer"). This is not a standing Assumptions section to fill: an assessment that assumed nothing load-bearing writes nothing here.
