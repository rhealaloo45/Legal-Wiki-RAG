...
1. List the specific factual aspects that need to be extracted for comparison.
   ...
   If the query is a complex multi-sentence narrative (e.g., "Identify which is most favourable to Acme. Check IP ownership, indemnities, and termination"), extract the core legal/commercial items needed to answer the overall question.
