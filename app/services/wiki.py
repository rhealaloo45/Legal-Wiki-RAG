...
SHORT CASE IDENTIFIER (first party's last name from the document, e.g. "Person 900"): \
  - Facts, Background, Procedural History, Parties → "Facts – Person 900 (Court Judgment)" \
  - Charges, FIR, Offences → "Charges – Person 900 (Court Judgment)" \
  - Holding, Disposition, Final Order → "Holding – Person 900 (Court Judgment)" \
  - Appellants'/Respondents' Contentions, Arguments → "Appellants' Contentions – Person 900 (Court Judgment)" \
  - Relief, Costs, Sentence → "Relief – Person 900 (Court Judgment)" \
...
1. CASE-SPECIFIC (facts, procedural history, charges, holding, parties, contentions, relief, costs): \
   ...
   e.g. "Procedural History – Person 900", "Facts – Person 900", "Holding – Person 900". \
...
- PAGE TITLES: You MUST append the inferred Document Type in parentheses to EVERY page title. \
  ...
  some topics prefixed with a case identifier (e.g. "Facts – Person 900") and some without \
  ...
  Example: "Facts – Person 900 ({doc_type})", "Section 319 CrPC ({doc_type})". \
