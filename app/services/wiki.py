...
def _resolve_docs_by_party(question: str, session_id: str, max_docs: int = 4) -> set[str]:
    ...
    for name, docs in resolved:
        ...
        # between Acme Elvara Limited and Umbrella Vehicles LLC" correctly pinned
        # the Umbrella SSA, then pulled in an unrelated Acme Elvara/Acme Elvara
        ...
        # Retention Agreement between Company042 Sagar Limited and Trey
        # Travel Limited" pinned the right KERA, then merged in four unrelated
        # Trey Travel instruments (an Escrow, a TSA, an SPA and a
