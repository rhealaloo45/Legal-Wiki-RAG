...
# or party name (e.g. "Voltco JV Agreement", "Meridian service agreement").
...
def _doc_identifier_part(title: str) -> str:
    ...
    the text AFTER ' – ' and BEFORE ' (' — e.g. "SA-Meridian", "JVVoltco",
    "Person 900". Topic words (before the dash) are NOT included, so generic
