...
_IOA = "Summit Meridian Software-IOA"
_IOA_AMDT = "Summit Meridian Software Amdt"
...
_NDA_MARGIE = "NDA_SUMMIT MARGIE TRADING"
...
SEED_CASES: list[dict] = [
    # ---------------------------------------------------------------- scope
    {
        ...
        "question": "What is the liability cap in the agreement between Summit Meridian Software and Fourthcoffee Data Centers?",
        ...
        "notes": "CORRECTED after the pipeline tier's first real run flagged this case as failing, "
                 ...
                 "('MAT-0000-0000'), not by party. Scope still reaches both correct documents, via the "
                 ...
                 "(a Loan Agreement page coincidentally containing both 'Fourthcoffee' and 'Meridian' from two "
    ...
    },
    {
        ...
        "archetype": "scope",
        "question": "What did the original IT Outsourcing Agreement say about payment terms, and how does the Summit Meridian amendment change it?",
    ...
    },
    {
        ...
        "archetype": "scope",
        "question": "Compare the confidentiality clauses of the Hooli NDA and the Summit Cobalt NDA.",
        ...
        "expect_docs": ["Hooli", "Summit Cobalt - NDA"],
    ...
    # --------------------------------------------------------------- answers
    {
        ...
        "question": "What is the liability cap in the Master Services Agreement dated 12 August 2020?",
        "expect_docs": ["2020-08-12"],
        "must_contain": ["443,994,657"],
        "expect_answer": "The aggregate liability cap is Rs. 443,994,657.",
    ...
    #   CONS  a Consultancy Agreement, Summit Gringotts Telecommunications / Person
    #         904, MAT-0000-0000. Person 008 is a natural person, so
    #         the name carries no corporate suffix — which is exactly what the
    #         party-pair resolver used to choke on.
    #   SPA   a Share Purchase Agreement, Summit Margie Company078 Entity (Buyer) /
    #         Litware Capital (Seller), MAT-0000-0000. One of SEVENTEEN real
    #         documents in this corpus between those same two parties.
    {
        ...
        "question": "What notice is required to terminate the consultancy agreement between "
                    "Pied Gringotts Private Limited and Person 008 for convenience?",
        "expect_docs": [_CONS],
        "must_contain": ["60"],
    ...
    },
    {
        ...
        "archetype": "factual",
        "question": "What insurance is Person 008 required to maintain under the consultancy agreement?",
        "expect_docs": [_CONS],
        "must_contain": ["63,941,282"],
        "expect_answer": "Comprehensive general liability and professional indemnity insurance of "
                         "not less than Rs. 63,941,282, maintained at Person 008's own cost for "
    ...
    },
    {
        ...
        "archetype": "factual",
        "question": "How quickly must Person 008 notify Summit Gringotts Telecommunications "
    ...
    },
    {
        ...
        "archetype": "factual",
        "question": "What audit rights does Pied Gringotts Private Limited have "
                    "over Person 008?",
        "expect_docs": [_CONS],
        "must_contain": ["15", "5%"],
        "expect_answer": "Summit Gringotts may audit Person 008's relevant books and records on not "
                         "less than 15 days' written notice, no more than once in any twelve-month "
                         "period, during normal business hours and at Summit Gringotts's cost — except "
    ...
    },
    {
        ...
        "archetype": "factual",
        "question": "When do milestone payments fall due under the consultancy agreement with Person 008?",
        "expect_docs": [_CONS],
        "must_contain": ["45"],
        "expect_answer": "Within 45 days of Summit Gringotts's written acceptance of the corresponding "
    ...
    },
    {
        ...
        "archetype": "factual",
        "question": "What is the take-or-pay minimum quantity under the agreement with Person 008?",
        "expect_docs": [_CONS],
        "must_contain": ["487,520"],
        "expect_answer": "487,520 units per annum, payable whether or not Summit Gringotts takes "
                         "delivery, save where non-delivery arises from a Force Majeure Event or "
                         "Person 008's own default.",
    ...
    },
    {
        ...
        "archetype": "factual",
        "question": "What is the aggregate liability cap for Summit Gringotts Telecommunications "
                    "Private Limited and Person 008, and what types of liability are excluded "
                    "from that cap?",
        "expect_docs": [_CONS],
        "must_contain": ["699,174,816", "fraud", "gross negligence",
                         "wilful misconduct", "confidentiality"],
        "expect_answer": "The aggregate liability cap is Rs. 699,174,816. It does not apply to "
    ...
    },
    {
        ...
        "archetype": "scope",
        "question": "Now look at the agreement where Company018 Margie LLC is the buyer "
                    "and Litware Capital Private Limited is the seller. What is the minimum annual "
                    "off-take commitment of Summit Margie, and what happens if it falls short?",
        "expect_docs": [_SPA],
        "must_contain": ["206,696"],
        "expect_answer": "Summit Margie must purchase not less than 206,696 units of the Products "
                         "each Contract Year (the Minimum Purchase Commitment). On a shortfall it "
                         "pays Litware Capital a shortfall fee equal to 5% of the value of the "
                         "shortfall.",
    ...
    },
    {
        ...
        "question": "Compare the security incident notification obligations of Person 008 to "
                    "Pied Gringotts Private Limited with those of Litware Capital "
                    "Private Limited to Company018 Margie LLC. Which counterparty has "
                    "the shorter contractual notification period?",
        "expect_docs": [_CONS, _NDA_MARGIE],
        "must_contain": ["24", "48"],
        "expect_answer": "Person 008 must notify within 24 hours; Litware Capital must notify "
                         "within 48 hours. Person 008 therefore has the shorter notification "
                         "period.",
        "notes": "THE HARDEST CASE IN THE SET, and the one that found a real bug. Scored 5/10: it "
                 ...
                 "causes: (1) 'Person 008' carries no corporate suffix so only THREE of the "
                 ...
                 "clause is titled 'NDA-Summit Margie' on every page and never says 'Litware', so "
    ...
    },
    {
        ...
        "archetype": "factual",
        "question": "From Company018 Margie LLC's perspective, what protections does it "
                    "have if Litware Capital Private Limited fails to achieve a contractual "
                    "milestone on time?",
        "expect_docs": [_SPA],
        "must_contain": ["0.5%"],
        ...
        "notes": "Scored 9/10. Worth keeping because the identical liquidated-damages wording "
                 ...
                 "a party pair and no instrument, and Summit Margie Company078 Entity and Litware Capital "
    ...
    },
    {
        ...
        "archetype": "abstention",
        "question": "Is Person 008 identified as the Consultant in the parties clause of the "
                    "consultancy agreement?",
        "expect_abstain": True,
        "expect_docs": [_CONS],
        "expect_answer": "The extracted parties text does not assign Person 008 the role label "
    ...
    },
    {
        ...
        "expect_answer": "17 Service Level Agreements, counted from the document index "
                         "rather than from a text search. The most recent is the Acme Power "
    ...
    },
    {
        ...
        "archetype": "factual",
        "question": "How many DPAs do we have that are with Acme Motors Limited?",
        "expect_docs": ["document-103"],
        "scope_resolved_by": "the document index, in count_documents_by_party",
        "expect_answer": "One: the Acme Motors data processing agreement dated 5 January 2021.",
    ...
    # ------------------------------------ Calculation Agent (Phase 5, Sept 2026)
    {
        ...
        "archetype": "factual",
        "question": "What is the total contract value of C02-X02-SOW-2026-001?",
        "expect_docs": ["C02-X02-SOW-2026-001"],
    ...
    },
    {
        ...
        "question": "What is our liquidated damages exposure after 40 weeks of delay under the "
                    "Summit Tailspin-Lakemere Defence SOW?",
        "expect_docs": ["Lakemere Defence-SOW"],
        "expect_answer": "INR 279,504,599.40, which is the aggregate cap. At the stated 0.5% "
                         ...
                         "4,196,696,229 - that is INR 372,672,799.20 - but the stated 15% "
    ...
    },
    {
        ...
        "archetype": "abstention",
        "question": "What is the liability cap in rupees under the Northwind Hotels MSA?",
        "expect_abstain": True,
