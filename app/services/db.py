...
def source_docs_with_title_token(wiki_id: str, session_id: str, token: str) -> list[str]:
    ...
    ("Definitions - SA1-Massive-Realty (Framework Supply Agreement)"). That
...
def backfill_clause_values(wiki_id: str, session_id: str | None = None,
    ...
    {'total': 'Rs. 2,517,591,304'}, {'total_value': 'Rs. 7,318,609,709'} — so
...
# "LegaOpin 17-04-2023", "MAT-0000-0000_...06-11-2024".
...
def date_from_filename(source_doc: str):
    ...
    for rx, order in _FILENAME_DATE_PATTERNS:
        ...
        try:
            ...
            continue
        # A filename can carry a matter year ("MAT-0000-0000") that is not a
...
def count_documents_by_party(wiki_id: str, session_id: str,
    ...
    for i, party in enumerate(parties or []):
        ...
        # elements: the corpus stores full legal names ("Acme Power Renewable
        # Energy Limited") and a lawyer asks for "Acme Power".
        clauses.append(f"""EXISTS (
...
def _plausible_heading(text: str) -> bool:
    ...
    opening of a wrapped body sentence ("LitwareForge shall maintain, test at
