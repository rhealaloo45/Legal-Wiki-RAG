...
The diagrams do carry real content. The floor plan on page 2 of the Stark
...
Usage:
    ...
    python3 backfill_figure_descriptions.py <session_id> --only "Stark Retail_CLD"
...
# of rent-table rows for the Stark Retail floor plan and not one room label.
_FIGURE_PROMPT = (
