...
- **Document disambiguation**: when a query targets an unspecified document, system asks user to pick from ingested docs or upload a new one. Skips automatically when the user names a specific document ("service agreement 1") or mentions a known entity/party name ("Voltco JV Agreement")
