...
- **Stance & Classification**: Analyzes the user's prompt to detect the desired negotiating stance (e.g., `acme_favorable`, `counterparty_favorable`, `neutral`) and classifies the request type (e.g., `clause`, `full_document`, `letter`).
